...
# Time capsule
In the description of this blog post, I emphasized the significance of my interactions with my charges. It might be surprising for those who glance at my portfolio and notice that the [last reflection on this topic](/portfolio/posts/meeting-charges-p3/) dates back to *October of last year*! 
...
***
{{< neighbouring >}}
{{< figure src="./images/food.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="I'll always remember the taste of this food." captionPosition="right" captionStyle="color: white;" >}}break{{< figure src="./images/piotr.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="Piotr never fails to share his genuine smile." captionPosition="right" captionStyle="color: white;" >}}
{{< /neighbouring >}}
***

# Piotr
In the last reflection, I mentioned that I [couldn't reach Piotr's mum](/portfolio/posts/meeting-charges-p3/#piotrek) to arrange a meeting with Piotrek. Fortunately, we were finally able to communicate, and I've resumed having regular meetings with Piotr. Through these sessions, I had the opportunity to get to know his mother better.
...
I also had the chance to apply my IT skills. Piotr's mum acquired a new DVD player for him because he enjoys watching cartoons, mainly Polish ones, but I also noticed he had Garfield. This player came with two types of cables: [RCA connectors](https://en.wikipedia.org/wiki/RCA_connector) and [SCART](https://en.wikipedia.org/wiki/SCART). 
...
***
{{< neighbouring >}}
{{< figure src="./images/rtv.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="Here I connect the DVD player to the TV." captionPosition="right" captionStyle="color: white;" >}}break{{< figure src="./images/rtv2.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="Here, you can two RCA connectors (red, yellow)" captionPosition="right" captionStyle="color: white;" >}}
{{< /neighbouring >}}
***
...
As I mentioned in [the blog post about the splits](/portfolio/posts/approaching-the-splits-5/#in-a-rush), I have encountered a new charge, Gosia. Well, technically, Gosia is not new to me. I met her during the Bury Mis Camp. However, I didn't interact with her. We didn't speak, spend time together during the camp—nothing. I just knew she existed.
...
***
{{< neighbouring >}}
{{< figure src="./images/gosia.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="On our way to enjoy the fresh air." captionPosition="right" captionStyle="color: white;" >}}break{{< figure src="./images/gosia3.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="Time to take a breath. Good job!" captionPosition="right" captionStyle="color: white;" >}}
{{< /neighbouring >}}
***
...
***
{{< neighbouring >}}
{{< figure src="./images/adam.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="Waiting to download the game." captionPosition="right" captionStyle="color: white;" >}}break{{< figure src="./images/tv.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="That's some truck over there!" captionPosition="right" captionStyle="color: white;" >}}
{{< /neighbouring >}}
***
...
I still don't know much about this foundation's mode of operation, but it's not the place to discuss it. [Click here](https://fundacja-arka.org.pl) to visit their website.

Coming back to Marcin, it's refreshing to see him in a new environment. Usually, he's quiet at his parent's house. I discussed why [here](/portfolio/posts/meeting-charges-p3/#marcin), but I'll summarize it with one word: parents. Not that they're a bad influence, but if you ever were a teenager, you would understand.
...
***
{{< neighbouring >}}
{{< figure src="./images/marcin2.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="Look at Marcin's incredible transformation." captionPosition="right" captionStyle="color: white;" >}}break{{< figure src="./images/marcin.jpeg" alt="Hello Friend" position="center" style="border-radius: 8px;" caption="Here, he's much more happier!" captionPosition="right" captionStyle="color: white;" >}}
{{< /neighbouring >}}
***
